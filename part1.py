from constants import ES_TRAIN_DATA_FILE, ES_TEST_DATA_FILE, ES_ACTUAL_DATA_FILE, ES_PART1_PREDICTED_DATA_FILE, RU_TRAIN_DATA_FILE, RU_TEST_DATA_FILE, RU_ACTUAL_DATA_FILE, RU_PART1_PREDICTED_DATA_FILE, UNK_WORD
...
if __name__ == "__main__":
    ...
    write_to_predicted_file_part(ES_PART1_PREDICTED_DATA_FILE, ES_test_data, ES_most_probable_tag)
    ...
    write_to_predicted_file_part(RU_PART1_PREDICTED_DATA_FILE, RU_test_data, RU_most_probable_tag)
